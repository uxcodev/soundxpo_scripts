...
function createdEmbedForm() {
  ...
  form__addembed.submit(function (e) {
    ...
    var url = `${apiURL}/artists/add-embed`;
  ...
  $('.btn__embed__delete').click(function () {
    ...
    var url = `${apiURL}/artists/delete-embed-slug`;
...
form__editprofile.submit(function (e) {
  ...
  var url = `${apiURL}/artists/edit-profile`;
...
$(".btn__claim__profile").click(function () {
  ...
  let url = `${apiURL}/artists/claim-profile`;
...
function getArtistId() {
  ...
  let url = `${apiURL}/artists/get-id-by-slug`
...
function updateArtistId(id) {
  ...
  let url = `${apiURL}/artists//update-artist-id`
  let data = {
    collection_id: "620536720c96daeda710d568",
    artist_id: id
  }
